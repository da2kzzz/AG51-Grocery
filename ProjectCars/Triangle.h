...
#ifndef PROJECTCARS_TRIANGLE_H
#define PROJECTCARS_TRIANGLE_H
...
const array<float,4> BROWN={0.8f,0.52f,0.25f,1.0f};
...
public:
    ...
    static array<float,4> getColorByName(const string &name) {
        ...
        else if (name.substr(0,4)=="GREY") return GREY;
        return BLACK;
    }

...
#ifndef CARS_CARMOVE_H
#define CARS_CARMOVE_H
#include "Vector2D.h"
...
public:
    ...
    void draw(char choice){
        int lx,ly;
        switch (choice) {
            case 'b':texture = GlutWindow::loadTGATexture("../Textures/cyancar.tga",lx,ly);
            break;
            case 'o':texture = GlutWindow::loadTGATexture("../Textures/orangecar.tga",lx,ly);
            break;
        }
